...
public class UDTEventHandler : MonoBehaviour, IUserDefinedTargetEventHandler
{
    ...
    public void OnNewTrackableSource(TrackableSource trackableSource)
    {
        ...
        GetComponent<FridgeManager>().UserDefineObj =  imageTargetCopy.gameObject;
        GetComponent<FridgeManager>().AssignFridgeObj();
        GetComponent<FridgeManager>().isCalculatingDistance = true;
